  ...
  return (
    <div className="py-20 w-[80%] mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-10 border-b border-b-[#00193133] pb-10">
        <div className="lg:w-[355px] w-[300px]">
          <img
        ...
        <div>
          <h1 className="lg:text-5xl text-2xl font-bold border-b-2 border-b-[#dbdfe657] pb-7">
            <span>{findAppDetailes.title}</span>
            <br />
            <span className="lg:text-xl text-lg font-light text-[#534f4f5b] mr-1">
              Developed by
            </span>
            <span className="lg:text-xl text-lg font-bold text-purple-500">
              {findAppDetailes.companyName}
            </span>
          </h1>
          <div className="details mt-5 mb-[30px] flex lg:flex-row flex-col justify-center items-center lg:gap-28 gap-8 text-center">
            <div className="flex flex-col justify-center items-center">
              <img
                ...
                alt="download"
              />
              <p className="text-[#001931] opacity-[0.8]">Downloads</p>
              <p className="lg:text-[40px] text-3xl font-extrabold text-[#001931]">
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                ...
                alt="rating"
              />
              <p className="text-[#001931] opacity-[0.8]">Average Ratings</p>
              <p className="lg:text-[40px] text-3xl font-extrabold text-[#001931]">
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                ...
                alt="review"
              />
              <p className="text-[#001931] opacity-[0.8]">Total Reviews</p>
              <p className="lg:text-[40px] text-3xl font-extrabold text-[#001931]">
      ...
      {/* description */}
      <h5 className="mt-10 mb-6 md:text-2xl text-lg font-semibold text-[#001931]">
        Description
      </h5>
      <p className="lg:text-xl text-[#627382] text-xs">
        {findAppDetailes.Part1_Overview}
      </p>{' '}
      <br />
      <p className="lg:text-xl text-[#627382] text-xs">
